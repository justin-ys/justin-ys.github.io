...
export default function MenuBar() {
   return <div className="menubar-container" style={{ display: 'flex', flexDirection: "column", alignItems: 'center', justifyContent: 'center', verticalAlign: 'middle' }}>
       {/* font suggestions from Stackoverflow's styling! --> */}
        <div className="menubar" style={{ backgroundColor: "#000000", display: "flex", paddingTop: "0.5em", paddingBottom: "0.5em", fontFamily: "Consolas Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace, serif", fontSize: "1.25em", gap: "2vw", alignItems: "center", justifyContent: "center", width: "100%"}}>
            <div style={{ color: "green"}}>home@justin-ys.github.io<span style={{ color: 'grey' }}>:</span>~<span style={{ color: 'grey' }}>$ cd</span></div>
